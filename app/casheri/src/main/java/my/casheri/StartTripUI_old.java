...
public class StartTripUI_old extends javax.swing.JFrame {

    public StartTripUI_old() {
        initComponents();
...
//        jXMapViewer1.setRoutingData(painter);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(StartTripUI_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
